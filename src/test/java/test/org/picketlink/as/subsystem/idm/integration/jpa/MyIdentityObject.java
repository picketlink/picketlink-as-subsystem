...
@Entity
public class MyIdentityObject implements Serializable {
    ...
    private MyPartitionObject partition;
    ...
    private MyIdentityObject parent;
    ...
    public MyPartitionObject getPartition() {
        return partition;
    }

    public void setPartition(MyPartitionObject partition) {
    ...
    public MyIdentityObject getParent() {
        return this.parent;
    }

    public void setParent(MyIdentityObject parent) {
        this.parent = parent;
    }
    ...
    public boolean equals(Object obj) {
        ...
        MyIdentityObject other = (MyIdentityObject) obj;

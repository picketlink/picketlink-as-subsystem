 ...
 */
public class RelationshipSetAddHandler extends AbstractResourceAddStepHandler {

    public static final RelationshipSetAddHandler INSTANCE = new RelationshipSetAddHandler();

    private RelationshipSetAddHandler() {
        super(ModelElement.RELATIONSHIPS);
    }

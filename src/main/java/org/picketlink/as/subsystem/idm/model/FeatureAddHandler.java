 ...
 */
public class FeatureAddHandler extends AbstractResourceAddStepHandler {

    public static final FeatureAddHandler INSTANCE = new FeatureAddHandler();

    private FeatureAddHandler() {
        super(ModelElement.FEATURE);
    }
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model,
        ...
        identityManagerService.configureFeatures(operation);
    }

 ...
 */
public class FeatureSetRemoveHandler extends AbstractRemoveStepHandler {

    public static final FeatureSetRemoveHandler INSTANCE = new FeatureSetRemoveHandler();

    private FeatureSetRemoveHandler() {
    }

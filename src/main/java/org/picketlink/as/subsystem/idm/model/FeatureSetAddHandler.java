 ...
 */
public class FeatureSetAddHandler extends AbstractResourceAddStepHandler {

    public static final FeatureSetAddHandler INSTANCE = new FeatureSetAddHandler();

    private FeatureSetAddHandler() {
        super(ModelElement.FEATURES);
    }

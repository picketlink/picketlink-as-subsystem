 ...
 * 
 */
public class JPAStoreWriteAttributeHandler extends AbstractWriteAttributeHandler<Void> {
    ...
    private JPAStoreWriteAttributeHandler() {
        super(JPAStoreResourceDefinition.ENTITY_MANAGER_FACTORY, JPAStoreResourceDefinition.DATA_SOURCE, JPAStoreResourceDefinition.REALMS, JPAStoreResourceDefinition.TIERS);
    }

 ...
 */
public class LDAPStoreRemoveHandler extends AbstractRemoveStepHandler {

    public static final LDAPStoreRemoveHandler INSTANCE = new LDAPStoreRemoveHandler();

    private LDAPStoreRemoveHandler() {
    }

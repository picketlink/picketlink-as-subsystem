 ...
 */
public class FileStoreRemoveHandler extends AbstractRemoveStepHandler {

    public static final FileStoreRemoveHandler INSTANCE = new FileStoreRemoveHandler();

    private FileStoreRemoveHandler() {
    }

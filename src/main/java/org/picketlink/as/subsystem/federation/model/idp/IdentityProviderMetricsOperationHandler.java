...
import org.picketlink.as.subsystem.federation.metrics.AbstractPicketLinkMetricsOperationHandler;
...
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_CREATED_ASSERTIONS_COUNT;
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_ERROR_RESPONSE_TO_SP_COUNT;
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_ERROR_SIGN_VALIDATION_COUNT;
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_ERROR_TRUSTED_DOMAIN_COUNT;
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_EXPIRED_ASSERTIONS_COUNT;
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_LOGIN_COMPLETE_COUNT;
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_LOGIN_INIT_COUNT;
import static org.picketlink.as.subsystem.model.ModelElement.METRICS_RESPONSE_TO_SP_COUNT;
...
public class IdentityProviderMetricsOperationHandler extends AbstractPicketLinkMetricsOperationHandler {
    ...
    static final SimpleAttributeDefinition[] ATTRIBUTES = {CREATED_ASSERTIONS_COUNT, RESPONSE_TO_SP_COUNT, ERROR_RESPONSE_TO_SP_COUNT,
                                                              ERROR_SIGN_VALIDATION_COUNT, ERROR_TRUSTED_DOMAIN_COUNT, EXPIRED_ASSERTIONS_COUNT,
